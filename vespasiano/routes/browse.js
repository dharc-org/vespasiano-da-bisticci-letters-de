...
router.get('/corrispondenti', function(req, res, next) {
	res.render('corrispondenti', { title: 'i corrispondenti', obj: 'DEI CORRISPONDENTI', senderRoleLetter, addresseeLetters});
});

/* GET browsing 'luoghi' page. */
router.get('/luoghi', function(req, res, next) {
	res.render('luoghi', { title: 'i luoghi', obj: 'DEI LUOGHI'});
});

/* GET browsing 'date' page. */
router.get('/date', function(req, res, next) {
	res.render('date', { title: 'le date', obj: 'DELLE DATE DI SPEDIZIONE'});
});

/* GET browsing 'segnatura' page. */
router.get('/segnatura', function(req, res, next) {
	res.render('segnatura', { title: 'le segnature', obj: 'DELLE SEGNATURE'});
});
